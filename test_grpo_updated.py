...
def main():
    try:
        ...
        # Optional: Test the trained model on a simple environment
        def test_trained_model(model_path):
            print("\nTesting trained model on a simple environment...")
            
            # Create a simple environment
            env = textworld.start("./games/tw-standard_42.z8")
            ...
            while not done and step < 10:
                action = agent.get_action(env, obs, infos, infos["admissible_commands"], step)
        ...
        # test_trained_model(save_model_path)
